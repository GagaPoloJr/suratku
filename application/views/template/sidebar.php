...
<aside class="main-sidebar elevation-4 sidebar-light-danger">
    ...
    <div class="sidebar">
        ...
        <?php elseif ($this->session->userdata('level') == '2') : ?>
            ...
            <div class=" user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?php echo base_url("dist/img/avatar3.png") ?>" class="img-circle elevation-2" alt="User Image">
                </div>
               
                <div class="info">
                    <a href="<?php echo base_url('admin/tampil_data_pegawai') ?>" class="d-block">Data Pegawai</a>
                </div>
            </div>
        <?php endif; ?>
        <!-- Sidebar Menu -->
